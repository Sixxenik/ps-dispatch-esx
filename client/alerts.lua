...
local function StoreVaultRobbery()
    local coords = GetEntityCoords(cache.ped)

    local dispatchData = {
        message = locale('storevaultrobbery'),
        codeName = 'storevaultrobbery',
        code = '10-90',
...
exports('StoreVaultRobbery', StoreVaultRobbery)
